...
func TestChartBudgetGetOverviewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Chart.Budget.GetOverview(context.TODO(), emceesprodtesting5.ChartBudgetGetOverviewParams{
		End:      time.Now(),
		Start:    time.Now(),
