...
func TestChartCategoryGetOverviewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Chart.Category.GetOverview(context.TODO(), emceesprodtesting5.ChartCategoryGetOverviewParams{
		End:      time.Now(),
		Start:    time.Now(),
