...
func TestAboutGetInfoWithOptionalParams(t *testing.T) {
	...
	_, err := client.About.GetInfo(context.TODO(), emceesprodtesting5.AboutGetInfoParams{
...
func TestAboutGetUserWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.About.GetUser(context.TODO(), emceesprodtesting5.AboutGetUserParams{
		XTraceID: emceesprodtesting5.String("40c71bbb-c676-4f24-83cf-cc725d7d7a00"),
	})
	if err != nil {
		var apierr *emceesprodtesting5.Error
